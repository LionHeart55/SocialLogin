		...
		<div class="wrap">
			...
			<div class="login-form">
				...
				<form class="login_form" name='loginForm' action="<c:url value='../j_spring_security_check' />" method='POST'>
					...
					<ul>
						<li>
							<input type="text" class="textbox1" id="username" name="j_username" value="" placeholder="Username" required="">
							<p><img src="../images/contact.png" alt=""></p>
						</li>
						<li>
							<input type="password" id="password" name="j_password" value="" class="textbox2" placeholder="Password">
				...
				<c:url value="../secure/signup" var="signupurl" />`
			<div class="account">
				<h2><a href="${signupurl}">Don't have an account? Sign Up!</a></h2>
				<div class="span">
					<form name='facebookSocialloginForm'
            		  action="<c:url value='../auth/facebook?scope=email,public_profile' />" method='POST'>
				...
				<div class="span3">
                	<form name='GoogleSocialloginForm'
                      action="<c:url value='../auth/google' />" method='POST'>
                		<img src="../static/images/gmail2.png" alt="">
                		<button type="submit">
                			<i>Google</i>
                		</button>
